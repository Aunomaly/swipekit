...
export default function DesignReviewApp() {
  ...
  const generateLink = async () => {
    ...
    try {
      ...
      const rUrl = `${window.location.origin}/results/r/${sessionId}`;
      ...
      {view === "share" && (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", gap: 28, padding: "40px 24px", maxWidth: 460, margin: "0 auto" }}>
          ...
          <div style={{ width: "100%", maxWidth: 380, display: "flex", flexDirection: "column", gap: 6 }}>
            <span style={{ color: "rgba(255,255,255,.3)", fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: ".08em", fontFamily: F }}>Reviewer link — share this</span>
